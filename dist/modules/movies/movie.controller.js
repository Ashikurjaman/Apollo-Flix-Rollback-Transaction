...
const getMovieBySlug = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const getMovieById = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    console.log(id);
    const result = yield movie_service_1.MovieServices.getMovieByID(id);
    res.status(200).json({
        success: true,
